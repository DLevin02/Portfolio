...
public class P3 {
    ...
    private static final String scriptPath = "./script.txt";
    ...
    private static final String generatedScriptPath = "./1.txt";
    private static final String youngScriptPath = "./script2.txt";
