...
public class MazeSolver {
    ...
    private static final String SVGFILEPATH = "./2.svg";

    private static final DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH.mm.ss.SSS");
    private static final String strDate = dateFormat.format(Calendar.getInstance().getTime());
    private static final String q1PlotOutputPath = "./q1-plot-" + strDate + ".txt";
    private static final String q2SuccOutputPath = "./q2-succ-" + strDate + ".txt";
    private static final String q3SolutionOutputPath = "./q3-solution-" + strDate + ".txt";
    private static final String q4PlotSolutionOutputPath = "./q4-plot_solution-" + strDate + ".txt";
    private static final String q5BfsOutputPath = "./q5-bfs-" + strDate + ".txt";
    private static final String q6BfsOutputPath = "./q6-dfs-" + strDate + ".txt";
    private static final String q7ManhattanDistancesOutputPath = "./q7-distances-" + strDate + ".txt";
    private static final String q8AStarManhattanOutputPath = "./q8-a_manhattan-" + strDate + ".txt";
    private static final String q9AStarEuclideanOutputPath = "./q9-a_euclidean-" + strDate + ".txt";
